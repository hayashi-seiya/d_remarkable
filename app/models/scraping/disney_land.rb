class Scraping::DisneyLand
  ...
  def initialize
    @land = Park.find_by(name: "land")
    @base_url = "http://disneyreal.asumirai.info"
    @index_url = "http://disneyreal.asumirai.info/realtime/disneyland-wait-today.html"
  end
  ...
  private
    ...
    attr_reader :land, :base_url, :index_url
    ...
    def scraping
      ...
      attractions.each do |attraction|
        attraction_param = land.attractions.build
